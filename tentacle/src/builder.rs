    ...
    K: KeyProvider,
{
    ...
    #[cfg(not(target_family = "wasm"))]
    pub fn tcp_proxy_config(mut self, proxy_url: Option<String>) -> Self {
        self.config.tcp_config.tcp.proxy_url = proxy_url;
        self
    }

    /// Onion config for tcp
    #[cfg(not(target_family = "wasm"))]
    pub fn tcp_onion_config(mut self, onion_url: Option<String>) -> Self {
        self.config.tcp_config.tcp.onion_url = onion_url;
        self
    }
